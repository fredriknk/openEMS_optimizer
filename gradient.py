...
def evaluation_fun(x, variable_names, fixed_params):
    ...
    try:
        ...
        logging.info(f"ifa_l: {ifa_l}, ifa_h: {ifa_h}, ifa_fp: {ifa_fp}, ifa_w1: {ifa_w1},ifa_w1: {ifa_w2},ifa_wf: {ifa_wf}, S11 at center frequency: {s11_value} - id {hash_prefix}")
...
if __name__ == "__main__":
    ...
    variable_names = ['ifa_l', 'ifa_h', 'ifa_fp', 'ifa_wf','ifa_w2','ifa_w1','ifa_fp','ifa_l','ifa_h']  # List variables you want to optimize
